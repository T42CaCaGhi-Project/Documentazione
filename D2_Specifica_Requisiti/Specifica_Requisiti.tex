...
\begin{description}
    \item[] \underline{Motivazione:} Dati i requisiti l'autenticazione avviene tramite un sistema di credenziali interno. \\
        È stato quindi identificato il componente \textbf{Gestione Autenticazione} che gestirà tutte le operazioni di autenticazione
\end{description}
...
\begin{description}
    \item[] \underline{Motivazione:} Dati i requisiti, la gestione degli eventi 
\end{description}
\subsubsection{Mappa}
\begin{description}
    \item[] \underline{Motivazione:}
