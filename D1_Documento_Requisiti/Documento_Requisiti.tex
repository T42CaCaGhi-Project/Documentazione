...
\begin{description}
    ...
    \item[] L'utente può visualizzare l'elenco degli eventi attraverso una lista e selezionando il range di tempo da visualizzare (Giorno, Settimana, Mese) o può visualizzare una mappa indicante gli eventi del giorno con la loro posizione
\end{description}
...
\begin{description}
    ...
    \item[] L'utente registrato ha accesso ai pulsanti "Partecipo" e "Salva Evento" che rispettivamente segnalano l'utente come partecipante o salvano l'evento nei preferiti dell'utente stesso.
